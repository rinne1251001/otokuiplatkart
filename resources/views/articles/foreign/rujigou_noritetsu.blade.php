...
@section('content')
    ...
    <main class="article">
        <section>
            <div>
                <img src="{{ asset('images/china2026/KIIP5282.jpg') }}" alt="泊まった宿">
            </div>
            <h3>クソ雑まとめ</h3>
            <div>
            ...
            <p>
                ...
                列車の時刻も12306で確認できるが、汝箕溝→銀川は時刻表ページに列車番号を入力しないと確認できない。<br> 
                                <a href="https://kyfw.12306.cn/otn/queryTrainInfo/init">12306時刻表</a>
        ...
        <section>
            ...
            <p>
                ...
                車内で閃光のハサウェイを見ていると、ハイジャック犯をボコボコにしたあたりで、何やら集団がやってきた。<br><br><br>
            <div>
      ...
      <p>
            ...
            <div>
               ...
               「心配しないでください。今日中関係が悪いので、これは日常の業務ですから。心配しないでください。」<br>
                ...
                ２時間くらいVIPルームにいたと思う。その後は北京で警官に護衛（）のもと、盧溝橋を見物して帰国しましたとさ。
            ...
            左：公安帰りのワイを癒すぬこ　右：公安にもらった水で入れた”公安ティー”

        </p>

            <h4>平汝鉄路おてがるストレートで君もVなSS3を撮ろう！</h4>
            <p>
